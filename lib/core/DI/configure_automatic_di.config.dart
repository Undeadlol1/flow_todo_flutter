...
import '../../features/authentification/presentation/cubit/authentification_cubit.dart'
    as _i3;
import '../../features/common/domain/use_cases/go_to_main_page.dart' as _i49;
...
import '../../features/goals/domain/use_cases/create_goal.dart' as _i46;
...
import '../../features/tasks/domain/use_cases/create_task.dart' as _i47;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i34.GetTasksWorkedOnToday>(_i34.GetTasksWorkedOnToday(
      tasksDoneTodayCubit: get<_i22.TasksWorkedOnTodayCubit>(),
      exceptionHandler: get<_i27.UseCaseExceptionHandler>(),
      getTasksDoneTodayRepository:
          get<_i12.GetTasksWorkedOnTodayRepository>()));
  gh.lazySingleton<_i35.IncrementDailyStreakAction>(() =>
      _i35.IncrementDailyStreakAction(
          profileCubit: get<_i17.ProfileCubit>(),
  ...
  gh.singleton<_i36.LevelProgressPercentageCalculator>(
      _i36.LevelProgressPercentageCalculator(
          ...
          experienceToReachALevelCalculator:
              get<_i29.ExperienceToReachNextLevelCalculator>()));
  gh.factory<_i37.LevelUpAnimation>(() => _i37.LevelUpAnimation(
      userLevelCalculator: get<_i28.UserLevelCalculator>(),
      buildContextProvider: get<_i15.BuildContextProvider>()));
  ...
  gh.factory<_i41.SignInWithGoogle>(() => _i41.SignInWithGoogle(
      profileCubit: get<_i17.ProfileCubit>(),
      firebaseAuth: get<_i39.FirebaseAuth>(),
      ...
      useCaseExceptionHandler: get<_i27.UseCaseExceptionHandler>()));
  gh.factory<_i42.ToggleTaskSelection>(() => _i42.ToggleTaskSelection(
      tasksCubit: get<_i21.TasksCubit>(),
  ...
  gh.singleton<_i44.UpdateTaskNote>(_i44.UpdateTaskNote(
      tasksCubit: get<_i21.TasksCubit>(),
      updateTaskRepository: get<_i25.UpdateTaskRepository>()));
  gh.factory<_i45.AddPointsToViewer>(() => _i45.AddPointsToViewer(
      profileCubit: get<_i17.ProfileCubit>(),
      levelUpAnimation: get<_i37.LevelUpAnimation>(),
      userLevelCalculator: get<_i28.UserLevelCalculator>(),
      updateProfileRepository: get<_i26.UpsertProfileRepository>()));
  gh.singleton<_i46.CreateGoal>(_i46.CreateGoal(
      goalsCubit: get<_i16.GoalsCubit>(),
      profileCubit: get<_i17.ProfileCubit>(),
      getTodaysDate: get<_i13.GetTodaysDate>(),
      createGoalRepo: get<_i4.CreateGoalRepository>(),
      addPointsToUser: get<_i45.AddPointsToViewer>(),
      uniqueIdGenerator: get<_i23.UniqueIdGenerator>(),
      useCaseExceptionHandler: get<_i27.UseCaseExceptionHandler>()));
  gh.lazySingleton<_i47.CreateTask>(() => _i47.CreateTask(
      tasksCubit: get<_i21.TasksCubit>(),
      profileCubit: get<_i17.ProfileCubit>(),
      getTodaysDate: get<_i13.GetTodaysDate>(),
      addPointsToUser: get<_i45.AddPointsToViewer>(),
  ...
  gh.singleton<_i48.MakeStepForwardOnTheTask>(_i48.MakeStepForwardOnTheTask(
      tasksCubit: get<_i21.TasksCubit>(),
      updateTask: get<_i25.UpdateTaskRepository>(),
      profileCubit: get<_i17.ProfileCubit>(),
      goToMainPage: get<_i49.GoToMainPage>(),
      goToTaskPage: get<_i14.GoToTaskPage>(),
      getTodaysDate: get<_i13.GetTodaysDate>(),
      updateProfile: get<_i26.UpsertProfileRepository>(),
      snackbarService: get<_i19.SnackbarService>(),
      workOnTaskAction: get<_i30.WorkOnTaskAction>(),
      addPointsToViewer: get<_i45.AddPointsToViewer>(),
      tasksDoneTodayCubit: get<_i22.TasksWorkedOnTodayCubit>(),
      incrementDailyStreak: get<_i35.IncrementDailyStreakAction>(),
