...
import 'package:firebase_analytics/firebase_analytics.dart' as _i47;
...
import '../../features/leveling/domain/services/user_level_calculator.dart'
    as _i33;
import '../../features/leveling/domain/use_cases/reset_experience.dart' as _i46;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i22.StaleTaskDetector>(() => _i22.StaleTaskDetector());
  gh.lazySingleton<_i23.StreakDaysInARowCalculator>(
      () => _i23.StreakDaysInARowCalculator());
  gh.lazySingleton<_i24.TaskRewardCalculator>(
      () => _i24.TaskRewardCalculator());
  ...
  gh.lazySingleton<_i40.IncrementDailyStreakAction>(() =>
      _i40.IncrementDailyStreakAction(
          profileCubit: get<_i19.ProfileCubit>(),
  ...
  gh.singleton<_i41.LevelProgressPercentageCalculator>(
      _i41.LevelProgressPercentageCalculator(
          ...
          experienceToReachALevelCalculator:
              get<_i34.ExperienceToReachNextLevelCalculator>()));
  gh.factory<_i42.LevelUpAnimation>(() => _i42.LevelUpAnimation(
      userLevelCalculator: get<_i33.UserLevelCalculator>(),
      buildContextProvider: get<_i15.BuildContextProvider>()));
  gh.singleton<_i43.Logout>(_i43.Logout(
      tasksCubit: get<_i25.TasksCubit>(),
      profileCubit: get<_i19.ProfileCubit>(),
      firebaseAuth: get<_i44.FirebaseAuth>(),
      firebaseFirestore: get<_i5.FirebaseFirestore>(),
      tasksDoneTodayCubit: get<_i26.TasksWorkedOnTodayCubit>(),
      authentificationCubit: get<_i3.AuthentificationCubit>()));
  gh.lazySingleton<_i45.MakeStepForwardOnAGoal>(() =>
      _i45.MakeStepForwardOnAGoal(
          goalsCubit: get<_i17.GoalsCubit>(),
          profileCubit: get<_i19.ProfileCubit>(),
          updateGoalRepo: get<_i28.UpdateGoalRepository>(),
          updateProfileRepository: get<_i30.UpsertProfileRepository>()));
  gh.factory<_i46.ResetExperience>(() => _i46.ResetExperience(
      profileCubit: get<_i19.ProfileCubit>(),
      firebaseAnalytics: get<_i47.FirebaseAnalytics>(),
      useCaseExceptionHandler: get<_i31.UseCaseExceptionHandler>(),
      upsertProfileRepository: get<_i30.UpsertProfileRepository>()));
  gh.factory<_i48.SignInWithGoogle>(() => _i48.SignInWithGoogle(
      profileCubit: get<_i19.ProfileCubit>(),
      firebaseAuth: get<_i44.FirebaseAuth>(),
      firebaseAnalytics: get<_i47.FirebaseAnalytics>(),
  ...
  gh.factory<_i52.AddPointsToViewer>(() => _i52.AddPointsToViewer(
      profileCubit: get<_i19.ProfileCubit>(),
      levelUpAnimation: get<_i42.LevelUpAnimation>(),
      userLevelCalculator: get<_i33.UserLevelCalculator>(),
      updateProfileRepository: get<_i30.UpsertProfileRepository>()));
  ...
  gh.singleton<_i55.MakeStepForwardOnTheTask>(_i55.MakeStepForwardOnTheTask(
      ...
      firebaseAnalytics: get<_i47.FirebaseAnalytics>(),
      tasksDoneTodayCubit: get<_i26.TasksWorkedOnTodayCubit>(),
      incrementDailyStreak: get<_i40.IncrementDailyStreakAction>(),
      useCaseExceptionHandler: get<_i31.UseCaseExceptionHandler>(),
