...
import '../../features/authentification/presentation/cubit/authentification_cubit.dart'
    as _i3;
import '../../features/common/domain/use_cases/go_to_main_page.dart' as _i36;
...
import '../../features/goals/data/update_goal_repository.dart' as _i20;
import '../../features/goals/domain/use_cases/create_goal.dart' as _i25;
...
import '../../features/tasks/data/update_task_repository.dart' as _i22;
import '../../features/tasks/domain/use_cases/create_task.dart' as _i26;
import '../../features/tasks/domain/use_cases/get_tasks_done_today.dart'
    as _i29;
import '../../features/tasks/domain/use_cases/get_tasks_to_do.dart' as _i30;
import '../../features/tasks/domain/use_cases/go_to_task_page.dart' as _i37;
import '../../features/tasks/domain/use_cases/make_step_forward_on_the_task.dart'
    as _i35;
import '../../features/tasks/domain/use_cases/reject_task.dart' as _i39;
import '../../features/tasks/domain/use_cases/update_task.dart' as _i40;
import '../../features/tasks/domain/use_cases/update_task_note.dart' as _i41;
...
import '../../features/users/data/update_profile_repository.dart' as _i21;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i20.UpdateGoalRepository>(
      () => _i20.UpdateGoalRepository(firestore: get<_i5.FirebaseFirestore>()));
  gh.factory<_i21.UpdateProfileRepository>(() =>
      _i21.UpdateProfileRepository(firestore: get<_i5.FirebaseFirestore>()));
  gh.factory<_i22.UpdateTaskRepository>(
      () => _i22.UpdateTaskRepository(firestore: get<_i5.FirebaseFirestore>()));
  gh.singleton<_i23.UseCaseExceptionHandler>(_i23.UseCaseExceptionHandler(
      snackbarService: get<_i15.SnackbarService>()));
  gh.singleton<_i24.AddPointsToViewer>(_i24.AddPointsToViewer(
      profileCubit: get<_i14.ProfileCubit>(),
      updateProfileRepository: get<_i21.UpdateProfileRepository>()));
  gh.singleton<_i25.CreateGoal>(_i25.CreateGoal(
      goalsCubit: get<_i13.GoalsCubit>(),
      profileCubit: get<_i14.ProfileCubit>(),
      getTodaysDate: get<_i12.GetTodaysDate>(),
      createGoalRepo: get<_i4.CreateGoalRepository>(),
      addPointsToUser: get<_i24.AddPointsToViewer>(),
      uniqueIdGenerator: get<_i19.UniqueIdGenerator>(),
      useCaseExceptionHandler: get<_i23.UseCaseExceptionHandler>()));
  gh.lazySingleton<_i26.CreateTask>(() => _i26.CreateTask(
  ...
  gh.singleton<_i29.GetTasksDoneToday>(_i29.GetTasksDoneToday(
      ...
      exceptionHandler: get<_i23.UseCaseExceptionHandler>(),
      getTasksDoneTodayRepository: get<_i10.GetTasksDoneTodayRepository>()));
  gh.singleton<_i30.GetTasksToDo>(_i30.GetTasksToDo(
      getTasks: get<_i11.GetTasksToDoRepository>(),
      tasksCubit: get<_i17.TasksCubit>()));
  gh.lazySingleton<_i31.IncrementDailyStreak>(() => _i31.IncrementDailyStreak(
      profileCubit: get<_i14.ProfileCubit>(),
      getTodaysDate: get<_i12.GetTodaysDate>(),
      tasksDoneTodayCubit: get<_i18.TasksDoneTodayCubit>(),
      updateProfile: get<_i21.UpdateProfileRepository>()));
  gh.singleton<_i32.Logout>(_i32.Logout(
      tasksCubit: get<_i17.TasksCubit>(),
      profileCubit: get<_i14.ProfileCubit>(),
      firebaseAuth: get<_i33.FirebaseAuth>(),
      tasksDoneTodayCubit: get<_i18.TasksDoneTodayCubit>(),
      authentificationCubit: get<_i3.AuthentificationCubit>()));
  gh.lazySingleton<_i34.MakeStepForwardOnAGoal>(() =>
      _i34.MakeStepForwardOnAGoal(
          goalsCubit: get<_i13.GoalsCubit>(),
          profileCubit: get<_i14.ProfileCubit>(),
          updateGoalRepo: get<_i20.UpdateGoalRepository>(),
          updateProfileRepository: get<_i21.UpdateProfileRepository>()));
  gh.singleton<_i35.MakeStepForwardOnTheTask>(_i35.MakeStepForwardOnTheTask(
      tasksCubit: get<_i17.TasksCubit>(),
      updateTask: get<_i22.UpdateTaskRepository>(),
      profileCubit: get<_i14.ProfileCubit>(),
      goToMainPage: get<_i36.GoToMainPage>(),
      goToTaskPage: get<_i37.GoToTaskPage>(),
      getTodaysDate: get<_i12.GetTodaysDate>(),
      updateProfile: get<_i21.UpdateProfileRepository>(),
      snackbarService: get<_i15.SnackbarService>(),
      addPointsToViewer: get<_i24.AddPointsToViewer>(),
      tasksDoneTodayCubit: get<_i18.TasksDoneTodayCubit>(),
      incrementDailyStreak: get<_i31.IncrementDailyStreak>(),
      nextRepetitionCalculator: get<_i38.NextRepetitionCalculator>()));
  gh.singleton<_i39.RejectTask>(_i39.RejectTask(
      tasksCubit: get<_i17.TasksCubit>(),
      goToMainPage: get<_i36.GoToMainPage>(),
      goToTaskPage: get<_i37.GoToTaskPage>(),
      snackbarService: get<_i15.SnackbarService>(),
  ...
  gh.singleton<_i40.UpdateTask>(_i40.UpdateTask(
      tasksCubit: get<_i17.TasksCubit>(),
      updateTaskRepository: get<_i22.UpdateTaskRepository>()));
  gh.singleton<_i41.UpdateTaskNote>(_i41.UpdateTaskNote(
      tasksCubit: get<_i17.TasksCubit>(),
      updateTaskRepository: get<_i22.UpdateTaskRepository>()));
  return get;
}
