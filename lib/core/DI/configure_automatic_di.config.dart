...
import 'package:firebase_crashlytics/firebase_crashlytics.dart' as _i38;
import 'package:firebase_remote_config/firebase_remote_config.dart' as _i46;
...
import '../../features/common/services/unique_id_generator.dart' as _i32;
...
import '../../features/goals/data/update_goal_repository.dart' as _i33;
import '../../features/goals/domain/use_cases/create_goal.dart' as _i63;
import '../../features/goals/domain/use_cases/get_goals.dart' as _i43;
...
import '../../features/quests/data/update_quest_repository.dart' as _i34;
import '../../features/quests/domain/use_cases/get_active_quests.dart' as _i42;
...
import '../../features/tasks/data/update_task_repository.dart' as _i35;
import '../../features/tasks/domain/actions/work_on_task_action.dart' as _i41;
...
import '../../features/tasks/domain/use_cases/get_tasks_to_do.dart' as _i47;
...
import '../../features/tasks/presentation/cubit/filtered_tasks_cubit.dart'
    as _i11;
import '../../features/tasks/presentation/cubit/tags_cubit.dart' as _i28;
import '../../features/tasks/presentation/cubit/tasks_cubit.dart' as _i30;
...
import '../../features/users/data/upsert_profile_repository.dart' as _i36;
import '../../features/users/domain/use_cases/add_points_to_viewer.dart'
    as _i62;
import '../../features/users/domain/use_cases/get_profile.dart' as _i44;
...
import '../remote_config/domain/use_cases/get_remote_config.dart' as _i45;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i28.TagsCubit>(_i28.TagsCubit());
  gh.factory<_i29.TaskRewardCalculator>(() => _i29.TaskRewardCalculator());
  gh.singleton<_i30.TasksCubit>(_i30.TasksCubit());
  gh.singleton<_i31.TasksWorkedOnTodayCubit>(_i31.TasksWorkedOnTodayCubit());
  gh.singleton<_i32.UniqueIdGenerator>(_i32.UniqueIdGenerator());
  gh.lazySingleton<_i33.UpdateGoalRepository>(
      () => _i33.UpdateGoalRepository(firestore: get<_i6.FirebaseFirestore>()));
  gh.factory<_i34.UpdateQuestRepository>(() =>
      _i34.UpdateQuestRepository(firestore: get<_i6.FirebaseFirestore>()));
  gh.factory<_i35.UpdateTaskRepository>(
      () => _i35.UpdateTaskRepository(firestore: get<_i6.FirebaseFirestore>()));
  gh.factory<_i36.UpsertProfileRepository>(() =>
      _i36.UpsertProfileRepository(firestore: get<_i6.FirebaseFirestore>()));
  gh.singleton<_i37.UseCaseExceptionHandler>(_i37.UseCaseExceptionHandler(
      snackbarService: get<_i25.SnackbarService>(),
      firebaseCrashlytics: get<_i38.FirebaseCrashlytics>()));
  gh.factory<_i39.UserLevelCalculator>(() => _i39.UserLevelCalculator(
      experienceToReachALevelCalculator:
          get<_i40.ExperienceToReachNextLevelCalculator>()));
  gh.factory<_i41.WorkOnTaskAction>(() => _i41.WorkOnTaskAction(
      tasksDoneTodayCubit: get<_i31.TasksWorkedOnTodayCubit>()));
  gh.factory<_i42.GetActiveQuests>(() => _i42.GetActiveQuests(
      getQuests: get<_i12.GetActiveQuestsRepository>(),
      uniqueIdGenerator: get<_i32.UniqueIdGenerator>(),
  ...
  gh.singleton<_i43.GetGoals>(_i43.GetGoals(
      goalsCubit: get<_i21.GoalsCubit>(),
      getGoalsRepo: get<_i13.GetGoalsRepository>(),
      useCaseExceptionHandler: get<_i37.UseCaseExceptionHandler>()));
  gh.singleton<_i44.GetProfile>(_i44.GetProfile(
      profileCubit: get<_i23.ProfileCubit>(),
      getProfileRepository: get<_i14.GetProfileRepository>(),
      useCaseExceptionHandler: get<_i37.UseCaseExceptionHandler>()));
  gh.factory<_i45.GetRemoteConfig>(() => _i45.GetRemoteConfig(
      remoteConfigCubit: get<_i24.RemoteConfigCubit>(),
      firebaseRemoteConfig: get<_i46.FirebaseRemoteConfig>(),
      useCaseExceptionHandler: get<_i37.UseCaseExceptionHandler>()));
  gh.singleton<_i47.GetTasksToDo>(_i47.GetTasksToDo(
      getTasks: get<_i15.GetTasksToDoRepository>(),
      tasksCubit: get<_i30.TasksCubit>(),
      exceptionHandler: get<_i37.UseCaseExceptionHandler>()));
  gh.singleton<_i48.GetTasksWorkedOnToday>(_i48.GetTasksWorkedOnToday(
      tasksDoneTodayCubit: get<_i31.TasksWorkedOnTodayCubit>(),
      exceptionHandler: get<_i37.UseCaseExceptionHandler>(),
  ...
  gh.lazySingleton<_i51.IncrementDailyStreakAction>(() =>
      _i51.IncrementDailyStreakAction(
          ...
          tasksDoneTodayCubit: get<_i31.TasksWorkedOnTodayCubit>(),
          updateProfile: get<_i36.UpsertProfileRepository>()));
  gh.singleton<_i52.LevelProgressPercentageCalculator>(
      _i52.LevelProgressPercentageCalculator(
          userLevelCalculator: get<_i39.UserLevelCalculator>(),
          experienceToReachALevelCalculator:
              get<_i40.ExperienceToReachNextLevelCalculator>()));
  ...
  gh.lazySingleton<_i56.MakeStepForwardOnAGoal>(() =>
      _i56.MakeStepForwardOnAGoal(
          goalsCubit: get<_i21.GoalsCubit>(),
          profileCubit: get<_i23.ProfileCubit>(),
          updateGoalRepo: get<_i33.UpdateGoalRepository>(),
          updateProfileRepository: get<_i36.UpsertProfileRepository>()));
  gh.factory<_i57.ResetExperience>(() => _i57.ResetExperience(
      profileCubit: get<_i23.ProfileCubit>(),
      firebaseAnalytics: get<_i50.FirebaseAnalytics>(),
      useCaseExceptionHandler: get<_i37.UseCaseExceptionHandler>(),
      upsertProfileRepository: get<_i36.UpsertProfileRepository>()));
  ...
  gh.factory<_i59.ToggleTaskSelection>(() => _i59.ToggleTaskSelection(
      ...
      firebaseAnalytics: get<_i50.FirebaseAnalytics>(),
      remoteConfigCubit: get<_i24.RemoteConfigCubit>(),
      updateTaskRepository: get<_i35.UpdateTaskRepository>()));
  ...
  gh.singleton<_i65.MakeStepForwardOnTheTask>(_i65.MakeStepForwardOnTheTask(
      tasksCubit: get<_i30.TasksCubit>(),
      updateTask: get<_i35.UpdateTaskRepository>(),
      profileCubit: get<_i23.ProfileCubit>(),
      ...
      updateProfile: get<_i36.UpsertProfileRepository>(),
      snackbarService: get<_i25.SnackbarService>(),
      rewardCalculator: get<_i29.TaskRewardCalculator>(),
      workOnTaskAction: get<_i41.WorkOnTaskAction>(),
