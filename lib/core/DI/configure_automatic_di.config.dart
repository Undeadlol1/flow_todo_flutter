...
import '../../features/goals/domain/use_cases/create_goal.dart' as _i48;
...
import '../../features/tasks/data/update_task_repository.dart' as _i27;
import '../../features/tasks/domain/actions/work_on_task_action.dart' as _i32;
import '../../features/tasks/domain/services/stale_task_detector.dart' as _i21;
import '../../features/tasks/domain/use_cases/create_task.dart' as _i49;
...
import '../../features/tasks/domain/use_cases/make_step_forward_on_the_task.dart'
    as _i50;
import '../../features/tasks/domain/use_cases/reject_task.dart' as _i52;
...
import '../../features/users/data/upsert_profile_repository.dart' as _i28;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i24.TasksWorkedOnTodayCubit>(_i24.TasksWorkedOnTodayCubit());
  ...
  gh.factory<_i27.UpdateTaskRepository>(
      () => _i27.UpdateTaskRepository(firestore: get<_i5.FirebaseFirestore>()));
  gh.factory<_i28.UpsertProfileRepository>(() =>
      _i28.UpsertProfileRepository(firestore: get<_i5.FirebaseFirestore>()));
  gh.singleton<_i29.UseCaseExceptionHandler>(_i29.UseCaseExceptionHandler(
      snackbarService: get<_i20.SnackbarService>()));
  gh.factory<_i30.UserLevelCalculator>(() => _i30.UserLevelCalculator(
      experienceToReachALevelCalculator:
          get<_i31.ExperienceToReachNextLevelCalculator>()));
  gh.factory<_i32.WorkOnTaskAction>(() => _i32.WorkOnTaskAction(
      tasksDoneTodayCubit: get<_i24.TasksWorkedOnTodayCubit>()));
  gh.singleton<_i33.GetGoals>(_i33.GetGoals(
      goalsCubit: get<_i17.GoalsCubit>(),
      getGoalsRepo: get<_i9.GetGoalsRepository>(),
      useCaseExceptionHandler: get<_i29.UseCaseExceptionHandler>()));
  ...
  gh.singleton<_i35.GetTasksToDo>(_i35.GetTasksToDo(
      ...
      exceptionHandler: get<_i29.UseCaseExceptionHandler>()));
  ...
  gh.lazySingleton<_i37.IncrementDailyStreakAction>(() =>
      _i37.IncrementDailyStreakAction(
          ...
          tasksDoneTodayCubit: get<_i24.TasksWorkedOnTodayCubit>(),
          updateProfile: get<_i28.UpsertProfileRepository>()));
  gh.singleton<_i38.LevelProgressPercentageCalculator>(
      _i38.LevelProgressPercentageCalculator(
          userLevelCalculator: get<_i30.UserLevelCalculator>(),
          experienceToReachALevelCalculator:
              get<_i31.ExperienceToReachNextLevelCalculator>()));
  gh.factory<_i39.LevelUpAnimation>(() => _i39.LevelUpAnimation(
      userLevelCalculator: get<_i30.UserLevelCalculator>(),
      buildContextProvider: get<_i15.BuildContextProvider>()));
  ...
  gh.lazySingleton<_i42.MakeStepForwardOnAGoal>(() =>
      _i42.MakeStepForwardOnAGoal(
          ...
          updateProfileRepository: get<_i28.UpsertProfileRepository>()));
  gh.factory<_i43.SignInWithGoogle>(() => _i43.SignInWithGoogle(
      profileCubit: get<_i18.ProfileCubit>(),
      firebaseAuth: get<_i41.FirebaseAuth>(),
      uniqueIdGenerator: get<_i25.UniqueIdGenerator>(),
      getProfileRepository: get<_i10.GetProfileRepository>(),
      upsertProfileRepository: get<_i28.UpsertProfileRepository>(),
      useCaseExceptionHandler: get<_i29.UseCaseExceptionHandler>()));
  gh.factory<_i44.ToggleTaskSelection>(() => _i44.ToggleTaskSelection(
      tasksCubit: get<_i23.TasksCubit>(),
      updateTaskRepository: get<_i27.UpdateTaskRepository>()));
  ...
  gh.singleton<_i46.UpdateTaskNote>(_i46.UpdateTaskNote(
      tasksCubit: get<_i23.TasksCubit>(),
      updateTaskRepository: get<_i27.UpdateTaskRepository>()));
  gh.factory<_i47.AddPointsToViewer>(() => _i47.AddPointsToViewer(
      profileCubit: get<_i18.ProfileCubit>(),
      levelUpAnimation: get<_i39.LevelUpAnimation>(),
      userLevelCalculator: get<_i30.UserLevelCalculator>(),
      updateProfileRepository: get<_i28.UpsertProfileRepository>()));
  gh.singleton<_i48.CreateGoal>(_i48.CreateGoal(
      goalsCubit: get<_i17.GoalsCubit>(),
      profileCubit: get<_i18.ProfileCubit>(),
      getTodaysDate: get<_i13.GetTodaysDate>(),
      createGoalRepo: get<_i4.CreateGoalRepository>(),
      addPointsToUser: get<_i47.AddPointsToViewer>(),
      uniqueIdGenerator: get<_i25.UniqueIdGenerator>(),
      useCaseExceptionHandler: get<_i29.UseCaseExceptionHandler>()));
  gh.lazySingleton<_i49.CreateTask>(() => _i49.CreateTask(
      tasksCubit: get<_i23.TasksCubit>(),
      profileCubit: get<_i18.ProfileCubit>(),
      getTodaysDate: get<_i13.GetTodaysDate>(),
      addPointsToUser: get<_i47.AddPointsToViewer>(),
  ...
  gh.singleton<_i50.MakeStepForwardOnTheTask>(_i50.MakeStepForwardOnTheTask(
      tasksCubit: get<_i23.TasksCubit>(),
      updateTask: get<_i27.UpdateTaskRepository>(),
      profileCubit: get<_i18.ProfileCubit>(),
      ...
      updateProfile: get<_i28.UpsertProfileRepository>(),
      snackbarService: get<_i20.SnackbarService>(),
      workOnTaskAction: get<_i32.WorkOnTaskAction>(),
      addPointsToViewer: get<_i47.AddPointsToViewer>(),
      tasksDoneTodayCubit: get<_i24.TasksWorkedOnTodayCubit>(),
      incrementDailyStreak: get<_i37.IncrementDailyStreakAction>(),
      nextRepetitionCalculator: get<_i51.NextRepetitionCalculator>()));
  gh.singleton<_i52.RejectTask>(_i52.RejectTask(
      tasksCubit: get<_i23.TasksCubit>(),
      goToMainPage: get<_i14.GoToMainPage>(),
      goToTaskPage: get<_i16.GoToTaskPage>(),
      snackbarService: get<_i20.SnackbarService>(),
